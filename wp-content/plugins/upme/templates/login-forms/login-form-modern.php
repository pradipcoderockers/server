...
<form action="" method="post" id="upme-login-form-<?php echo $login_code_count; ?>">
    ...
    <div class="upme-modern-field " style="border:none;">
        ...
        <div class="upme-modern-field-remember">
            ...
            <div class="upme-login-form-link" >
                <span class="links"><?php echo $login_form_link; ?></span>
            </div>
            <div class="upme-clear"></div>


            
            <input type="submit" name="upme-login" class="upme-modern-btn <?php echo $login_btn_class; ?>" value="<?php echo  __('Log In', 'upme'); ?>" /><br />
