    ...
    <div class="upme-elegant-field ">
        ...
        <div class="upme-elegant-field-value">
            ...
            <div class="upme-rememberme <?php echo $remember_me_class; ?>">
                <i class="<?php echo $class; ?>"></i> <span><?php echo  __('Remember me', 'upme'); ?></span>
                <input type="hidden" name="rememberme" id="rememberme-<?php echo  $login_code_count; ?>" value="0" />
            </div>
            <input type="submit" name="upme-login" class="upme-clasic-btn <?php echo $login_btn_class; ?>" value="<?php echo  __('Log In', 'upme'); ?>" /><br />

            <div class="upme-elegant-login-pass-link">
