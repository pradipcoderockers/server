<?php
    ...
    $upme_admin->add_plugin_module_setting(
            'checkbox',
            'email_content_type_status',
            'email_content_type_status',
            __('Enable HTML Content in Emails', 'upme'),
            '0',
            __('If checked, email content type will be set to text/html.', 'upme'),
            __('Checking this option will allow you to add HTML tags to email notifications.', 'upme')
    );
