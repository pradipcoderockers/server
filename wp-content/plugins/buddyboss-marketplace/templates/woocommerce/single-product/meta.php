...
<div class="product_meta">
    ...
    <?php if ( wc_product_sku_enabled() && ( $product->get_sku() || $product->is_type( 'variable' ) ) ) : ?>
        ...
        <span class="sku_wrapper"><?php _e( 'SKU:', 'buddyboss-marketplace' ); ?> <span class="sku" itemprop="sku"><?php echo ( $sku = $product->get_sku() ) ? $sku : __( 'N/A', 'buddyboss-marketplace' ); ?></span></span>
