 ...
 *
 * This template can be overridden by copying it to yourtheme/bb-marketplace/woocommerce/order/order-details-customer.php.
 *
	...
	<?php if ( ! wc_ship_to_billing_address_only() && $order->needs_shipping_address() ) : ?>
		...
		<div class="col-3">
			<div class="box-inner">
				...
				<address>
					<?php echo ( $address = $order->get_formatted_shipping_address() ) ? $address : __( 'N/A', 'buddyboss-marketplace' ); ?>
				</address>
			</div>
		</div><!-- /.col-3 -->
